...
|---|---|---|---:|---|
| [Ethiopia Yirgacheffe Harfusa Washed G1](beans/ethiopia-harfusa.md) | 활성 | [500ml Tumbler Flash v1](recipes/candidates/harfusa-flash-500-v1.md) | 0 | v1 추출 후 맛·drawdown·ice remaining 기록 |
...
- [Harfusa · 315ml Flash brew · 2026-08-23](research/2026-08-23-harfusa.md) — Aiden/Ode/과학/전문가/커뮤니티/원두 조사 완료, exact roaster·물·서빙 세부 gap
...
1. 500ml v1 첫 brew에서 carafe output, transfer 온도, drawdown, ice remaining 측정
2. 추출 직후와 5분 후의 베르가못 clarity·백도 sweetness를 비교해 실제 우선순위 확인
