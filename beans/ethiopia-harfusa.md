...
type: bean
status: active
name: "Ethiopia Yirgacheffe Harfusa Washed G1"
origin: "Ethiopia"
region: "SNNPR Region · Gedeo Zone · Yirgacheffe"
producer_or_station: "Harfusa Kebele"
altitude: "1,800–2,100m"
variety: "Heirloom"
process: "Washed"
roast_level: "Medium–Light"
roast_date: 2026-08-14
roaster: "미기록"
tasting_notes: ["베르가못", "백도", "오렌지필"]
created: 2026-08-23
updated: 2026-08-23
---

# Ethiopia Yirgacheffe Harfusa Washed G1

## 확인된 정보

| 항목 | 값 | 출처 | 신뢰도 |
|---|---|---|---|
| 산지 | Ethiopia, Gedeo, Yirgacheffe | 사용자 제공 | High |
| 지역/생산지 | Harfusa Kebele | 사용자 제공 | High |
| 고도 | 1,800–2,100m | 사용자 제공 | High |
| 품종 | Heirloom | 사용자 제공 | High |
| 가공 | Washed | 사용자 제공 | High |
| 로스팅 | Medium–Light | 사용자 제공 | High |
| 로스팅 날짜 | 2026-08-14 | 사용자 제공 | High |
| 로스터 | 미기록 | — | — |
| 기준 물 | 제주삼다수 | 사용자 제공 | High |
...
- 고지대 washed Ethiopia는 밀도가 높고 미분이 많을 수 있어 지나치게 가는 분쇄에서 drawdown과 떫음 위험이 있다.
- Aiden의 닫힌 추출 환경과 높은 추출 효율을 고려해 99°C 기본 Light profile보다 낮은 declining temperature를 첫 가설로 사용한다.
- 위 두 항목은 이 원두의 측정 결과가 아니라 범주 기반 출발 가설이다. 첫 brew의 맛과 drawdown이 우선한다.
